...
module Bundler
  ENV_LOADED   = true
  LOCKED_BY    = '0.9.25'
  FINGERPRINT  = "b048cb3ff5461ad142b9a4f3d0724662a8da6f4c"
  HOME         = '/Users/ryandotsmith/.bundle/ruby/1.8/bundler'
  AUTOREQUIRES = {:test=>[["rspec", false], ["rspec-rails", false]], :default=>[["authlogic", false], ["facets/dictionary", true], ["factory_girl", false], ["formtastic", false], ["friendly_id", false], ["haml", false], ["hoptoad_notifier", false], ["pg", false], ["rails", false], ["ruby-debug", false], ["sanitize", false], ["sqlite3", true]], :cucumber=>[["cucumber-rails", false], ["database_cleaner", false], ["webrat", false]]}
  SPECS        = [
